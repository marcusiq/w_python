...
valid = {0: [1, 4], 1: [0, 2, 5], 2: [1, 3, 6], 3: [2, 7], 4: [0, 5, 8],
         5: [1, 4, 6, 9], 6: [2, 5, 7, 10], 7: [3, 6, 11], 8: [4, 9], 9:[5, 8, 10], 10:[6, 9, 11],  11:[7, 10]}
...
show_number_of_moves_widget  = Entry(info_frame, width=5, justify=LEFT)  # Add code to CENTER the display here.
...
status_label = Label(info_frame, text="Status: Not Started", bg="black", fg="green")
