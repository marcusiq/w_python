    ...
    for m in range(n+1, 11, 2):
        ...
        for k in range(1, 21):
            ...
            if gcd(m,n) == 1:  # Test if m and n are coprime.
                ...
                triple.sort()
                if c <= 100:    # Only take triples in the target range.
                    # 9. Append the list [a, b, c] to the list of triples.
                    pythagorean_triple.append( triple )
                    print "(%2d, %2d, %2d)" % tuple(triple)
for triple in pythagorean_triple(100):
    a,b,c = triple
    abc = a*b*c
    print triple, "\t------>", factorint(abc)



# 10. Print out the number of Pythagorean triples you found.
number_found = len(pythagorean_triple)
