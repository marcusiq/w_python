...
#mlp_2 = MLPClassifier(hidden_layer_sizes=(8), solver='sgd', learning_rate_init=8) # easiest to break
mlp_3 = MLPClassifier(hidden_layer_sizes=(20), solver='adam', learning_rate_init=.001)# not as hard to break
...
number_misclassified = Confusion_Matrix3[0][1] + Confusion_Matrix3[1][0]
